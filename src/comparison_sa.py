...
def rsa_collect_replicas_comparison(replicas_limit, size, alpha, sample_size=10, path="data/rsa/comparison_replicas_data.csv"):
...
if __name__ == "__main__":
    ...
    # size = 800
    # alpha = 0.2
    # rsa_collect_replicas_comparison(alpha_limit, size, num_replicas, sample_size=5, path="data/test/comparison_replicas_data.csv")
